...
INSERT INTO trans (id, date, is_reconciled, type) VALUES (142, '20231202', 0, 1); -- Deposit 142

INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231102',  375756,  40, 42, 142, 'Mainstreet Renewal - Amherst Residential LLC');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231122', 10059,  40,  6, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231128',  4646,  40, 10, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231127',  8296,  40, 11, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231123',  3654,  40, 12, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231122',  1054,  80, 15, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231120',  4920,  40, 17, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231121',  9868,  40, 18, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231127',  5987,  40, 20, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231122',   110,  40, 30, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231125',  3456,  40, 31, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231124',   151,  40, 32, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231201',  5865,  40, 35, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231124',  1019,  80, 36, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231125',  2654,  40, 37, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231123',  5062,  40, 38, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231120',  5454,  40, 40, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231121',  3700,  40, 44, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231125',  5341,  40, 45, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231121',  1918,  40, 47, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231120',  6638,  40, 50, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231130',  3516,  40, 53, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231125',  5433,  40, 61, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231127',  1305,  40, 64, 142, '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231127',  9197,  40, 66, 142, '');
...
INSERT INTO trans (id, date, is_reconciled, type) VALUES (144,  '20231215', 0, 1); -- Deposit 144 
...
INSERT INTO trans (id, date, is_reconciled, type) VALUES (145,  '20240102', 0, 1); -- Deposit 145 

INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231123',      0,  40,  3, 145,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231218',    800,  40,  8, 145,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231213',   9740,  40, 13, 145,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231214',   6732,  40, 34, 145,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231228',   1071,  40, 58, 145,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231220',  32315,  40, 59, 145,  'Synergy Title - FILE: SYN2319413');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231217',   3093,  40, 63, 145,  '');

UPDATE trans SET amount = (SELECT SUM(amount) FROM fees WHERE fk_trans_id = 145)  WHERE id = 145;


-- 2024-01-03 Deposit 146
INSERT INTO trans (id, date, is_reconciled, type) VALUES (146, '20240103', 0, 1); -- Deposit 146
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231223',    429,  40, 52, 146,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231229',    171,  40, 68, 146,  '');
UPDATE trans SET amount = (SELECT SUM(amount) FROM fees WHERE fk_trans_id = 146)  WHERE id = 146;

-- 2024-02-22 Deposit 147
INSERT INTO trans (id, date, is_reconciled, type) VALUES (147, '20240222', 0, 1); -- Deposit 147
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20240112',   1037,  40, 14, 147,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20240110',   5285,  40, 25, 147,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20231201',    516, 160, 29, 147,  '');
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20240118',   5085,  80, 51, 147,  '');
UPDATE trans SET amount = (SELECT SUM(amount) FROM fees WHERE fk_trans_id = 147)  WHERE id = 147;

-- 2024-06-10 Deposit 148
INSERT INTO trans (id, date, is_reconciled, type) VALUES (148, '20240610', 0, 1); -- Deposit 148
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20240523',  33593,  40, 17, 148,  'Synergy Title, File: SYN2419842');
UPDATE trans SET amount = (SELECT SUM(amount) FROM fees WHERE fk_trans_id = 148)  WHERE id = 148;

-- 2024-07-19 Deposit 149
INSERT INTO trans (id, date, is_reconciled, type) VALUES (149, '20240719', 0, 1); -- Deposit 149
INSERT INTO fees(date, ck_no, amount, fk_lot_id, fk_trans_id, note) VALUES('20240627', 68006888,  80, 28, 149,  'Leaders Title Company, LLC, File No. LW240274');
UPDATE trans SET amount = (SELECT SUM(amount) FROM fees WHERE fk_trans_id = 149)  WHERE id = 149;
